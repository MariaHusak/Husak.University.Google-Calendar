...
command = 'python3 D:/04/Husak.University.Google-Calendar/manage.py create_reminders'
...
script_content = f'''
$action = New-ScheduledTaskAction -Execute 'python3' -Argument 'D:/04/Husak.University.Google-Calendar/manage.py create_reminders'
